export function createMainActions({
  closeModal,
  moveButton,
  openModal,
  showContent,
  ...
  return {
    'quick-link': showContent.bind(null, uiRefs.quicklink, uiRefs.quickcontent),
    'stats-link': showContent.bind(null, uiRefs.statlink, uiRefs.statscontent),
    'misc-link': showContent.bind(null, uiRefs.misclink, uiRefs.misccontent),
...
export function createButtonActions({
  ...
  return {
    ...
    search123: () => executeSearch('search123'),
    search456: () => executeSearch('search456'),
...
export function createChangeActions({ altFetch, firstload }) {
  return {
    ...
    mc_pregnancy_hole: altFetch.update_pregnancy_mc,
...
export function createInputActions({ firstload }) {
  return {
