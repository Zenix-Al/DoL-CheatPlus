...
function init_interface(){
	...
	generatetext(['', 'mc_baby_select', 'mc_baby_tooltip', 'mc_baby_action_select', 'mc_baby_input', 'mc_baby_set', 'purgeNPCBaby', 'purgeNPCBabyInfo'], ['text', 'select', 'tooltip', 'select', 'checkbox', 'button', 'button', 'tooltip'], ['Baby', ['placeholder'], "placeholder", babyOptions, '','Set','Purge', 'Purging your baby also inclduing Named npc (eg. alex).'], 'misc-content');
